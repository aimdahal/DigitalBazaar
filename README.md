# Digital bazar (E-Commerce Website)
...
Note: The payment page is created only for demo purpose using Stripe  and its not fully integrated with any original payment gateway. So for now any credit card details will be accepted and the demo orders will be placed.
...
Step 4: In Select an App Section: select Other (custom name) => enter "Digital Bazaar" => Generate
